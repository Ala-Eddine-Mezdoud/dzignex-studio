...
export const ShimmerButtonLight = React.forwardRef<
  HTMLButtonElement,
  ShimmerButtonProps
>(
  (
    ...
    return (
      <button
        ...
        className={cn(
          ...
          "border border-white/20 px-6 py-3 text-white [background:var(--bg)] [border-radius:var(--radius)]",
          "backdrop-blur-md", // adds blur
      ...
      >
        {/* spark container */}
        <div className="-z-30 absolute inset-0 overflow-visible [container-type:size] blur-[2px]">
...
ShimmerButtonLight.displayName = "ShimmerButtonLight";
