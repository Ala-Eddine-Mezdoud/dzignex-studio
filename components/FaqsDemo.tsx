...
export function FaqsDemo() {
  return (
    ...
    >
      ...
      <AccordionItem value="item-2" className=" border-[#f3f6ff]/10  text-[#f3f6ff] px-8">
      ...
      <AccordionItem value="item-3" className=" border-[#f3f6ff]/10  text-[#f3f6ff] px-8">
        <AccordionTrigger className="text-[22px] font-medium tracking-[-1px]">Product Information</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance r text-[18px] text-[#f3f6ff]/80">
          <p>
            Our flagship product combines cutting-edge technology with sleek
      ...
      <AccordionItem value="item-4" className=" border-[#f3f6ff]/10  text-[#f3f6ff] px-8">
        <AccordionTrigger className="text-[22px] font-medium tracking-[-1px]">Product Information</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance r text-[18px] text-[#f3f6ff]/80">
          <p>
            Our flagship product combines cutting-edge technology with sleek
      ...
      <AccordionItem value="item-5" className=" border-[#f3f6ff]/10  text-[#f3f6ff] px-8">
        <AccordionTrigger className="text-[22px] font-medium tracking-[-1px]">Product Information</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance r text-[18px] text-[#f3f6ff]/80">
          <p>
            Our flagship product combines cutting-edge technology with sleek
      ...
      <AccordionItem value="item-6" className=" border-[#f3f6ff]/10  text-[#f3f6ff] px-8">
        <AccordionTrigger className="text-[22px] font-medium tracking-[-1px]">Product Information</AccordionTrigger>
        <AccordionContent className="flex flex-col gap-4 text-balance r text-[18px] text-[#f3f6ff]/80">
          <p>
            Our flagship product combines cutting-edge technology with sleek
