...
const Footer = () => {
  return (
    <footer className=" text-gray-300 py-12 px-6 border-t border-grey">
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto mt-12  pt-6 flex flex-col md:flex-row justify-between items-center text-sm text-gray-400">
