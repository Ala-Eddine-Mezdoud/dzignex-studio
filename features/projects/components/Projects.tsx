        ...
        <div className="mt-10 md:mt-16 relative md:grid md:grid-cols-6">
          ...
          <div className="md:col-span-4 flex flex-col gap-8 md:gap-0">
            ...
            <div className="flex justify-end mt-4 md:mt-8">
              <Link href="/projects" className="bg-dzignex-white text-dzignex-black px-4 py-2 text-sm md:text-base lg:text-xl font-semibold tracking-tight uppercase w-full md:w-fit text-center hover:bg-dzignex-blue hover:text-white transition-colors">
                Explore Portfolio
              </Link>
            </div>
          </div>
